...
INSERT INTO tiggle.program (id, age, program_end_date, program_info, program_name, program_start_date,
                            reservation_open_date, runtime, category_id, location_id) VALUES
                                                                                          (null, 14, '2024-09-29', '뮤지컬 〈시카고〉', '시카고', '2024-06-27',
                                                                                           '2024-05-01', 145, 1, 1),
                                                                                          (null, 12, '2024-10-31', '뮤지컬 〈레 미제라블〉', '레 미제라블', '2024-08-01',
                                                                                           '2024-06-01', 160, 1, 2),
                                                                                          (null, 8, '2024-12-15', '뮤지컬 〈라이온 킹〉', '라이온 킹', '2024-09-15',
                                                                                           '2024-07-01', 135, 1, 3),
                                                                                          (null, 10, '2024-11-20', '뮤지컬 〈위키드〉', '위키드', '2024-08-20',
                                                                                           '2024-06-15', 150, 1, 4),
                                                                                          (null, 7, '2024-08-30', '뮤지컬 〈캣츠〉', '캣츠', '2024-05-30',
                                                                                           '2024-04-01', 130, 1, 5),
                                                                                          (null, 15, '2024-09-30', '공연 〈베토벤 교향곡〉', '베토벤 교향곡', '2024-07-01',
                                                                                           '2024-05-01', 120, 2, 1),
                                                                                          (null, 16, '2024-11-10', '공연 〈모차르트 레퀴엠〉', '모차르트 레퀴엠', '2024-09-10',
                                                                                           '2024-07-10', 90, 2, 2),
                                                                                          (null, 18, '2024-10-25', '공연 〈바흐 무반주 첼로 모음곡〉', '바흐 무반주 첼로 모음곡', '2024-08-25',
                                                                                           '2024-06-25', 105, 2, 3),
                                                                                          (null, 13, '2024-12-05', '공연 〈쇼팽 피아노 협주곡〉', '쇼팽 피아노 협주곡', '2024-09-05',
                                                                                           '2024-07-05', 110, 2, 4),
                                                                                          (null, 12, '2024-08-15', '공연 〈비발디 사계〉', '비발디 사계', '2024-06-15',
                                                                                           '2024-05-01', 100, 2, 5);
